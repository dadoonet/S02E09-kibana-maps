...
# Start of the script
echo Installation script for Kibana Maps demo with Elastic $ELASTIC_VERSION
...
curl_delete "$ELASTICSEARCH_URL/kibana_sample_data_flights"
...
curl_post_form "$KIBANA_URL/api/saved_objects/_import?overwrite=true" "kibana-config/map.ndjson"
curl_post_form "$KIBANA_URL/api/saved_objects/_import?overwrite=true" "kibana-config/dashboard.ndjson"
